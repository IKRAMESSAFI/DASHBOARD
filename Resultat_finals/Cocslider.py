...
def read_geotiff(file_path):
    try:
        ...
        if "HTTP response code: 404" in str(e):
            print(f"Error: GeoTIFF file not found. Check the URL: {file_path}")
        else:
...
def main():
    ...
    file_url1= "https://ikramessafi.github.io/DATAPARQUET/DONNEE_MAROC.parquet"
    file_path= download_file(file_url1)
    ...
    geo_tiff_file_path = f"https://kaoutar-elmouh.github.io/ikramimage/images/{selected_attribute}{selected_day}.tif"
    cog_file_path = f"https://ikramessafi.github.io/GOG/COG/cog{selected_attribute}{selected_day}.tif"
